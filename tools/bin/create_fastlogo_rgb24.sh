...
ffmpeg -i $ifile -pix_fmt rgb24 -s 800x1280 -f rawvideo -vf "transpose=1, transpose=1" - | cat >> $ofile
ffmpeg -i $ifile -pix_fmt rgb24 -s 800x480 -f rawvideo -vf transpose=2 - | cat >> $ofile
