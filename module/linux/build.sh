...
if [ "is${CONFIG_BERLIN_AS470_A0}" != "isy" ]; then
    ...
    cp -av ${opt_linux_src}/firmware/bcm/*.hcd ${opt_outdir_release}/lib/firmware/bcm;
    cp -av ${opt_linux_src}/firmware/bcm/brcmbt ${opt_outdir_release}/lib/firmware/bcm;
    cp -av ${opt_linux_src}/firmware/bcm/*.conf ${opt_outdir_release}/lib/firmware/bcm;
    cp -av ${opt_linux_src}/firmware/bcm/*.cal ${opt_outdir_release}/lib/firmware/;
    cp -av ${opt_linux_src}/firmware/bcm/*.blob ${opt_outdir_release}/lib/firmware/;
    cp -av ${opt_linux_src}/firmware/bcm/*.bin ${opt_outdir_release}/lib/firmware/;
fi
...
if [ "is${CONFIG_BERLIN_AS470_A0}" != "isy" ]; then
    copy_subdir ${opt_outdir_release}/lib ${opt_workdir_runtime_sysroot}/lib firmware
