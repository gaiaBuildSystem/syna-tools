...
if [ "is${CONFIG_BERLIN_AS470_A0}" = "isy" ]; then
  opt_basedir_security_keys="${CONFIG_SYNA_SDK_OUT_TARGET_PATH}/${CONFIG_SECURITY_KEY_PATH}"
  opt_basedir_security_tools="${CONFIG_SYNA_SDK_OUT_TARGET_PATH}/${CONFIG_SECURITY_TOOL_PATH}"
  opt_workdir_security_keys="${CONFIG_SYNA_SDK_OUT_TARGET_PATH}/${CONFIG_SECURITY_KEY_PATH}/${syna_chip_name}/${syna_chip_rev}"
else
