# Bash script: subimage: linux_bootimgs: spi
...
if [ "is${CONFIG_NO_PREPEND_IMG_INFO}" = "isy" ]; then
  cp ${outdir_subimg_intermediate}/linux_bootimgs_en.bin ${outfile_linuxbootimgs_subimg}
else
  ${basedir_tools}/prepend_image_info.sh ${outdir_subimg_intermediate}/linux_bootimgs_en.bin ${outfile_linuxbootimgs_subimg}
fi
