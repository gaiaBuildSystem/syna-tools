...
get_pt_id() {
  ...
  case "$name" in
    ...
    "boot" | "boot_a" | "boot_b") echo "0x00020018" ;;
    "key" | "key_a" | "key_b") echo "0x00020050" ;;
    "firmware" | "firmware_a" | "firmware_b") echo "0x00020051" ;;
    "rootfs" | "rootfs_a" | "rootfs_b") echo "0x00020052" ;;
    "fastlogo" | "fastlogo_a" | "fastlogo_b") echo "0x00020053" ;;
    "factory_setting") echo "0x00020070" ;;
    "misc") echo "0x00020071" ;;
    "userdata") echo "0x00020072" ;;
...
# process A slot
valid_a_slot="tzk|tzk_a|bl|bl_a|boot|boot_a|key|key_a|firmware|firmware_a|fastlogo|fastlogo_a|rootfs|rootfs_a"
...
for ((i=2; i<=${lines}; i++)); do
  ...
  case "$pt_name" in
    ...
    "sysmgr" | "sysmgr_a")
      ...
      ;;
    tzk|tzk_a|bl|bl_a|uboot|boot|boot_a|key|key_a|firmware|firmware_a|fastlogo|fastlogo_a|rootfs|rootfs_a)
    #$valid_a_slot)
...
for ((i=2; i<=${lines}; i++)); do
  ...
  case "$pt_name" in
    ...
    "sysmgr_b")
      ...
      ;;
    tzk_b|bl_b|boot_b|key_b|firmware_b|fastlogo_b|rootfs_b)
      pt_id=$(get_pt_id ${pt_name})
      gen_boot_entry ${pt_offset} ${pt_id} ${pt_size} ${flash_offset} $pt_name
